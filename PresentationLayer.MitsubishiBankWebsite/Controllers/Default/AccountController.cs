...
using PresentationLayer.MitsubishiBankWebsite.Controllers.Intranet;
...
namespace PresentationLayer.MitsubishiBankWebsite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<ActionResult> RegisterPost(AddCustomerViewModel model)
        {
            BankAdminController admin = new BankAdminController();
            var customer = admin.AddCustomer(model);
